...
このブランチはAoE2.netDesktopの GitHub page のソースコードです。

https://teshiba.github.io/AoE2.netDesktop/ をご確認ください。

## Jekyll テーマ

[Mr. Green Jekyll Theme](https://github.com/MrGreensWorkshop/MrGreen-JekyllTheme) を使用しています。
